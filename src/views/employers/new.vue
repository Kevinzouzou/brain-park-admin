                    ...
                    <el-dialog :title=addEditTitle :visible.sync="addEditVisible">
                        <el-form :model="addEditForm" label-width="80px" ref="addEditForm">
                            ...
                            <el-form-item label="缩略图">
                                <el-upload :action=url list-type="picture-card" :on-preview="handleHAPictureCardPreview" :on-remove="handleHARemove" :file-list="imgHAList"
                                    :on-success="moreHAShow">
                            ...
                            <el-tab-pane label="商务服务" name="firstSer">
                                ...
                                <el-dialog :title=addEditTitle :visible.sync="commerSerAEVisible">
                                    <el-form :model="comSerAEForm" label-width="80px" ref="comSerAEForm">
                                        ...
                                        <el-form-item label="缩略图">
                                            <el-upload :action=url list-type="picture-card" :on-preview="handleComSerCardPreview" :on-remove="handleComSerRemove" :file-list="imgComSerList"
                                                :on-success="moreComSerShow">
                                                <i class="el-icon-plus"></i>
                                            </el-upload>
                ...
                <el-tab-pane label="信息化建设" name="third">
                    ...
                    <el-dialog :title=addEditTitle :visible.sync="infoConAEVisible">
                        <el-form :model="infoConAEForm" label-width="80px" ref="infoConAEForm">
                            ...
                            <el-form-item label="缩略图">
                                <el-upload :action=url list-type="picture-card" :on-preview="handleInfoConCardPreview" :on-remove="handleInfoConRemove" :file-list="imgInfoConList"
                                    :on-success="moreInfoConShow">
                                    <i class="el-icon-plus"></i>
                                </el-upload>
