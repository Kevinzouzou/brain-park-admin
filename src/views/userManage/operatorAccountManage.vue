<template>
    <section>
        ...
        <!--工具条-->
        <!--列表-->
        <el-table :data="parkOperatorList.slice((page-1)*pagesize,page*pagesize)" highlight-current-row v-loading="parkOperatorListLoading" style="width: 100%;">
            ...
            <el-table-column label="操作" width="150">
                <template slot-scope="scope">
                    <el-button type="info" size="small" @click="parkOperatorEdit(scope.$index, scope.row)">编辑</el-button>
        ...
        <el-row :gutter="24">
            <el-col :span="24" class="toolbar">
                <el-pagination background @size-change="pageSizeChange" @current-change="pageCurrentChange" :page-sizes="[7,8,10,20]" :page-size="pagesize" layout="total,sizes, prev, pager, next, jumper" :current-page="page" :total="parkOperatorListTotal" style="float:right;">
                </el-pagination>
            </el-col>
        </el-row>
        <!--工具条-->
        ...
        <!-- 修改操作员弹框 -->
        <el-dialog title="修改操作员" :visible.sync="editParkOperatorFormVisible">
            <el-form :model="editParkOperatorForm" :rules="editParkOperatorFormRules" v-show="!editParkOperatorFormIsShow" :label-position="'right'" label-width="150px" ref="editParkOperatorForm">
                <el-row :gutter="24">
                    <el-col :span="11">
                ...
                <el-row :gutter="24">
                    <el-col :span="10">
                        <el-form-item label="姓名：">
                            <span>{{editParkOperatorForm.ownerInfo.name}}</span>
                        </el-form-item>
                        <el-form-item label="岗位：">
                            <span>{{editParkOperatorForm.ownerInfo.position}}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="10">
                        <el-form-item label="工号：">
                            <span>{{editParkOperatorForm.ownerInfo.empNo}}</span>
                        </el-form-item>
                        <el-form-item label="部门：">
