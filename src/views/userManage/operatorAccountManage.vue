        ...
        <el-dialog title="操作员详情" :visible.sync="editParkOperatorFormVisible">
            <el-form :model="editParkOperatorForm" :rules="editParkOperatorFormRules" v-show="!editParkOperatorFormIsShow" :label-position="'right'"
                ...
                <el-row :gutter="24">
                    <el-col :span="10">
                        <el-form-item label="姓名：">
                            <span v-if="editParkOperatorForm.ownerInfo">{{editParkOperatorForm.ownerInfo.addInfo.name}}</span>
                        </el-form-item>
                        <el-form-item label="岗位：">
                            <span v-if="editParkOperatorForm.ownerInfo">{{editParkOperatorForm.ownerInfo.addInfo.position}}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="10">
                        <el-form-item label="工号：">
                            <span v-if="editParkOperatorForm.ownerInfo">{{editParkOperatorForm.ownerInfo.addInfo.empNo}}</span>
                        </el-form-item>
                        <el-form-item label="部门：">
                            <span v-if="editParkOperatorForm.ownerInfo">{{editParkOperatorForm.ownerInfo.departmentInfo.name}}</span>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
